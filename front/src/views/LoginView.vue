...
<!--    -->
  ...
  <div style="height: 100vh;width: 100% ;overflow:hidden;">
    ...
    <div style="width: 400px;margin: 150px auto ;">
      <div style="font-size:30px;text-align: center;padding: 30px 0">教师登录</div>
      <el-form ref="form" :rules="rules"
        ...
        <el-form-item>
          <router-link to="/checkerLogin">
            <el-button type="primary">审核员登录</el-button>
          </router-link>
  ...
  methods:{
    login(){
      this.$refs['form'].validate((valid) => {
        if (valid) {
          request.post("/teacher/login",this.admin).then(res=>{
            console.log(res);
            if(res.code=='0'){
